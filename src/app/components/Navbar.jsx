...
import { ActivityIcon, GlobeIcon, HomeIcon, LayoutGridIcon, MenuIcon, MountainIcon, MoveIcon, Play, PlaySquare, Search, UsersIcon } from "lucide-react"
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div className="flex-1">
        ...
        <main className="p-4 lg:p-8 max-h-screen overflow-scroll bg-background">
          <BreadcrumbDemo />
          {children}
          <ToggleMode />
        </main>
